...
st.title("Analisis Clustering Agglomerative (GMM) dan Regresi Ensemble Meetode (ASSO, RIDGE, ELASTICNET)")
...
st.header("Analisis Clustering (Gaussian Mixture Model)")
...
df_encoded["Cluster"] = gmm.fit_predict(X_scaled)
